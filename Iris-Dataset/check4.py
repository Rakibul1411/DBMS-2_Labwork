...
def read_iris_dataset():
    dataset = []
    with open('/Users/md.rakibulislam/IIT Life/All Semester in IIT Life/5th Semester/5th Semester Lab Codes/CSE-504/DBMS-2_Lab/Iris-Dataset/iris.csv', newline='') as csv_file:
...
if __name__ == '__main__':
    ...
    # test_set = random.sample(dataset, int(0.25 * len(dataset))) 
        test_set = []
        #species_samples = {"serosa": [], "versicolor": [], "virginica": []}
        ...
        # Select 10 random samples from each species
    ...
    print("Avg. accuracy on test set: " + "{:.2f}".format(avg_accuracy* 100) + "%")
